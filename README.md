# MB-NLP
MB-NLP -> Modeling Book Datasheet with NLP 
...
2. Download the dataset you want to train and predict your system with. (https://www.kaggle.com/sp1thas/book-depository-dataset?select=dataset.csv)
